...
public class SimpleConsentRepair implements FileRenamerInterface { // this is an adapter class for LmsSimpleConsentRepair.
	private LmsSimpleConsentRepair fileRenamerPath;
	
	public SimpleConsentRepair(LmsSimpleConsentRepair fileRenamerPath) {
