...
public class FileRenamerAllPhotosLms implements FileRenamerInterface { // decorator class
	private FileRenamerInterface renamer; // reference to object being decorated
	private String[] photoTypes = {".jpg", ".jpeg", ".bmp", ".png", ".pdf", ".PDF", ".tif"}; // different photo types/file types
	private int numberOfFilesRenamed; // this decorator has its own numberOfFilesRenamed count 
	
	public FileRenamerAllPhotosLms(FileRenamerInterface renamer) {
