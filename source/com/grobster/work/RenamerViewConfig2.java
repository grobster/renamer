...
public class RenamerViewConfig2 implements FileRenamerObserver {
	...
	public RenamerViewConfig2(FileRenamerInterface renamer) {
	...
	public void createView() {
		...
		frame = new JFrame("Photo Renamer v11.2.0");
	...
	private void runLogCompression() {
		Path p = Paths.get(System.getProperty("user.home") + System.getProperty("file.separator") + "FileRenamer" + System.getProperty("file.separator") + "logs");
		Zipper.zipDirectory(p.toString(), p.toString(), ".txt", 180); // zips files that are 180 days and older
	}
